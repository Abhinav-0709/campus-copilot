...
import { BookOpen, Calendar, Clock, FileText, Upload, Download, Eye, CheckCircle, XCircle } from 'lucide-react';
...
const ASSIGNMENTS = [
  ...
  },
  {
    ...
    submissionType: 'document',
    submittedOn: '2025-05-22',
    feedback: 'Excellent work on the API design. Very thorough documentation and well-thought-out endpoints.'
  }
];
