...
export default function FacultyLayout({ children }: FacultyLayoutProps) {
  ...
  const navigation = [
    ...
    { name: 'Mark Attendance', href: '/faculty/attendance', icon: Users },
    { name: 'Assignments', href: '/faculty/assignments', icon: ClipboardList },
    { name: 'Leave Requests', href: '/faculty/leave-management', icon: FileText },
    { name: 'RAG Knowledge Base', href: '/faculty/manage-content', icon: BookOpen },
    { name: 'Notice Board', href: '/faculty/notices', icon: Bell },
    { name: 'Faculty Community', href: '/faculty/community', icon: MessageSquare },
    { name: 'Events Calendar', href: '/faculty/events', icon: Calendar },
  ];
        ...
        <header className="flex h-16 shrink-0 items-center justify-between bg-[#EEF2F6] dark:bg-[#080B0E] px-6">
          <div className="flex items-center space-x-3">
            ...
            <span className="text-xs font-bold text-[#475569] dark:text-[#A3ADB8] hidden sm:inline-block">
              Techville University • Faculty Administration
            </span>
          </div>
